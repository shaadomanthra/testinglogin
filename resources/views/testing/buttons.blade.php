@include('testing.modules.head')
  <div class="container">
    ...
    <div class="alert alert_one alert-primary mt-2" role="alert" style="display: none;">
      <h4 class="alert-heading">Well done!</h4>
      <p id="alert_message" class=" alert_message mb-0 pb-0">You have clicked <b>Button One</b></p>
    </div>
    <div class="alert alert_two alert-success mt-2" role="alert" style="display: none;">
      <h4 class="alert-heading">Well done!</h4>
      <p id="alert_message" class=" alert_message mb-0 pb-0">You have clicked <b>Button Two</b></p>
    </div>
    <div class="alert alert_three alert-danger mt-2" role="alert" style="display: none;">
      <h4 class="alert-heading">Well done!</h4>
